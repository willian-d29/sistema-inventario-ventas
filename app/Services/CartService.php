...
class CartService
{
     ...
     * @throws CartNotFoundException
     */
    public function updateQuantity(int $id, int $userId, array $payload): Cart
    {
        $cart = $this->findByIdForUserOrFail(
            id: $id,
            userId: $userId,
    ...
    public function incrementQuantity(int $id, int $userId): Cart
    {
        $cart = $this->findByIdForUserOrFail(
            id: $id,
            userId: $userId,
     ...
     * @throws Exception
     */
    public function decrementQuantity(int $id, int $userId): Cart
    {
        $cart = $this->findByIdForUserOrFail(
            id: $id,
            userId: $userId,
